...
import ru.qa.scooter.praktikum.model.MainPage;
import ru.qa.scooter.praktikum.model.OrderPage;
...
public class WebTest {
    ...
    public static Object[][] testData(){
        return new Object[][] { {"Александр", "Сергеевич", "Ленина", "87777777777", ""},
                {"Андрей", "Александрович", "Смоленская", "00777777777", "комментарий"},
                {"Евгений", "Михайлович", "Улица", "12347777789", "12321"}};
    }
    ...
    public void checkOrderFlowHead(){
        ...
        mainPage.clickHeadOrderButton();
        OrderPage orderPage = new OrderPage(driver);
        orderPage.inputFirstOrderPageAndGo("Алекс","Золотов", "Новотушинская", "79955230553" );
